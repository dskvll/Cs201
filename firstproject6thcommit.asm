...
addi $a0, $a0, 49# this is the ascii value for 'r'
syscall 

addi $a0, $a0, -5# this is the ascii value for 'm'
syscall

addi $a0, $a0, -12# this is the ascii value for 'a'
syscall 

addi $a0, $a0, 13# this is the ascii value for 'n'
syscall 

addi $a0, $a0, -5# this is the ascii value for 'i'
syscall
